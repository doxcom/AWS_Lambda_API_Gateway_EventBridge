import boto3  #is a lib for AWS Soft dev kit to enable devs to interact with AWS Services for py apps
import json
...
def lambda_handler(event, context):
    ...
    if instance_type != 't2.micro':
        ...
        print(f"Instance {instance_id} stopped because it is not a t2.micro instance.")
